...
public class WorkflowEngineConstants {
    ...
    public static class SqlQueries {
        ...
        public static final String GET_APPROVAL_LIST_RELATED_TO_USER = "SELECT TASK_ID FROM WF_WORKFLOW_APPROVAL_RELATION WHERE EVENT_ID = ?";
        ...
        public static final String UPDATE_APPROVAL_LIST_RELATED_TO_USER = "UPDATE WF_WORKFLOW_APPROVAL_RELATION SET TASK_ID=?, EVENT_ID=?,WORKFLOW_ID=?,APPROVER_TYPE=?,APPROVER_NAME=?";
