...
FOREIGN KEY (EVENT_ID) REFERENCES  WF_WORKFLOW_APPROVAL_RELATION(EVENT_ID) ON DELETE CASCADE,
FOREIGN KEY (WORKFLOW_ID) REFERENCES  WF_WORKFLOW_APPROVAL_RELATION(WORKFLOW_ID) ON DELETE CASCADE
);
